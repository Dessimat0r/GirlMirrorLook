...
{	
	...
	void SetCameraOrientation()
	{
		...
		UnityEngine.Transform tf = transform.Find("/OVRPlayerController/ForwardDirection/Mia/Hips/Spine/Spine1/Spine2/Neck");
		tf.transform.rotation = camera.transform.rotation;
